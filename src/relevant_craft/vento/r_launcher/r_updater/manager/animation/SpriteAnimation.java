...
public class SpriteAnimation extends Transition {
    ...
    public SpriteAnimation(String spiteName, Duration duration, int count, int columns, int offsetX, int offsetY, int width, int height) {
        Image image = PictureManager.loadImage(spiteName);
